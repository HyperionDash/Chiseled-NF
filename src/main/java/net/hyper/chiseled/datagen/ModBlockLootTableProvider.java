...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropWhenSilkTouch(ModBlocks.FRAMED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_WHITE_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_LIGHT_GRAY_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_GRAY_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_BLACK_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_BROWN_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_RED_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_ORANGE_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_YELLOW_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_LIME_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_GREEN_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_CYAN_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_LIGHT_BLUE_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_BLUE_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_PURPLE_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_MAGENTA_STAINED_GLASS.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_PINK_STAINED_GLASS.get());

        dropWhenSilkTouch(ModBlocks.FRAMED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_WHITE_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_LIGHT_GRAY_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_GRAY_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_BLACK_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_BROWN_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_RED_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_ORANGE_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_YELLOW_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_LIME_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_GREEN_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_CYAN_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_LIGHT_BLUE_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_BLUE_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_PURPLE_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_MAGENTA_STAINED_GLASS_PANE.get());
        dropWhenSilkTouch(ModBlocks.FRAMED_PINK_STAINED_GLASS_PANE.get());
